    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            <div className="lg:col-span-5 bg-slate-50 p-8 sm:p-16 lg:p-24 border-r border-slate-100 flex flex-col justify-between">
              ...
              <div className="mt-20 p-8 bg-brand-black text-white relative overflow-hidden group">
                  ...
                  <p className="text-white/50 text-[10px] font-medium leading-relaxed mb-8">
              ...
              <div className="max-w-2xl mx-auto">
                {formState === 'success' ? (
                  <div className="h-full flex flex-col items-center justify-center text-center py-20 animate-fade-up">
                    ...
                    <p className="text-slate-500 text-lg font-medium max-w-sm mx-auto mb-12">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-12">
                    <div className="reveal active">
                        ...
                        <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.4em]">Define your organizational objectives</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 reveal active delay-100">
                        <div className="space-y-4">
                            <label htmlFor="firstName" className="text-[9px] font-black text-slate-400 uppercase tracking-widest block">Given Name</label>
                            <input 
                        ...
                        <div className="space-y-4">
                            <label htmlFor="lastName" className="text-[9px] font-black text-slate-400 uppercase tracking-widest block">Surname</label>
                            <input 
                    ...
                    <div className="reveal active delay-200">
                        <label htmlFor="email" className="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-4">Corporate Email</label>
                        <input 
                    ...
                    <div className="reveal active delay-300">
                        <label htmlFor="service" className="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-4">Strategic Objective</label>
                    ...
                    <div className="reveal active delay-400">
                        <label htmlFor="message" className="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-4">Context & Scope</label>
                        <textarea 
      ...
      <section className="py-24 bg-brand-black text-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <p className="text-white/40 text-sm mb-12 font-medium max-w-xl mx-auto">
