...
export const SEO_GUIDES: SeoGuide[] = [
  ...
  guide('digital-marketing-agency-toronto-law-firms',
    ...
    'Choosing a digital marketing agency for your Toronto law firm — what to look for, law-firm-specific SEO and PPC tactics, Law Society of Ontario advertising rules, and realistic pricing ranges from Onsective.',
    'Marketing',
  ...
  guide('immigration-law-firm-marketing-toronto',
    ...
    'Marketing an immigration law firm in Toronto — keyword economics, multilingual content strategy, CICC vs LSO compliance, and intake systems that convert international enquiries. A practitioner guide from Onsective.',
    'Marketing',
  ...
  guide('saas-development-company-toronto',
    ...
    'Choosing a SaaS development company in Toronto — talent ecosystem, stack decisions, multi-tenant architecture, SOC 2 compliance, engagement models, and realistic pricing. A practitioner guide from Onsective.',
    'Software',
  ...
  guide('custom-legal-software-development-toronto',
    ...
    'Building custom legal software in Toronto — when off-the-shelf tools fall short, data residency and privilege, integrations with LexisNexis and Westlaw, build-vs-buy frameworks, and pricing. A practitioner guide from Onsective.',
    'Software',
  ...
  guide('cloud-hosting-canadian-law-firms',
    ...
    'Cloud hosting for Canadian law firms — data residency, PIPEDA and Law Society compliance, Azure Canada Central vs AWS ca-central-1 vs GCP Montreal, Microsoft 365 rules, and migration. A practitioner guide from Onsective.',
    'Cloud',
